locals {
  ...
  dynamic_environment_gitlab_agent_path_candidate = local.gitlab_agent_enabled && local.gitlab_agent_config_project_path != null ? "${local.gitlab_agent_config_project_path}:${local.gitlab_agent_name}" : null
  dynamic_environment_gitlab_agent_path = try(var.dynamic_environments_project.gitlab_agent_path, null) != null ? var.dynamic_environments_project.gitlab_agent_path : (
    local.dynamic_environment_gitlab_agent_path_candidate != null ? local.dynamic_environment_gitlab_agent_path_candidate : ""
  )
}
